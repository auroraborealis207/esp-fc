...
#endif
        Param(PSTR("pin_input_0"), &c.pin[PIN_INPUT_0]),
        Param(PSTR("pin_input_1"), &c.pin[PIN_INPUT_1]),
        Param(PSTR("pin_input_2"), &c.pin[PIN_INPUT_2]),
        Param(PSTR("pin_input_3"), &c.pin[PIN_INPUT_3]),
        Param(PSTR("pin_input_4"), &c.pin[PIN_INPUT_4]),
        Param(PSTR("pin_input_5"), &c.pin[PIN_INPUT_5]),
        Param(PSTR("pin_input_6"), &c.pin[PIN_INPUT_6]),
        Param(PSTR("pin_input_7"), &c.pin[PIN_INPUT_7]),
